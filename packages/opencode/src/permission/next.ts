...
export namespace PermissionNext {
  ...
  function persistApproved(projectID: string, ruleset: Ruleset) {
    Database.use((db) =>
      db
  ...
  export const reply = fn(
    ...
    (input) => {
      ...
      if (input.reply === "always") {
        ...
        try {
          persistApproved(Instance.project.id, s.approved)
        } catch (error) {
          log.error("failed to persist approved permissions", { error })
        }

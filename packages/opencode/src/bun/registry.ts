...
async function info(pkg: string, field: string, cwd?: string): Promise<string | null> {
...
async function isOutdated(pkg: string, cachedVersion: string, cwd?: string): Promise<boolean> {

...
import { tmpdir, canCreateSymlinks } from "../fixture/fixture"
...
test.skipIf(!(await canCreateSymlinks()))("symlink handling", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {
...
test.skipIf(!(await canCreateSymlinks()))("nested symlinks", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {
...
test.skipIf(!(await canCreateSymlinks()))("circular symlinks", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {

...
test("transforms share data to storage format", () => {
  const data: ShareData[] = [
    ...
    { type: "message", data: { id: "msg-1", sessionID: "sess-1" as any } as any },
    { type: "part", data: { id: "part-1", messageID: "msg-1" as any } as any },
    { type: "part", data: { id: "part-2", messageID: "msg-1" as any } as any },
  ]
